// Generated by @wagmi/cli@0.1.10 on 3/26/2023 at 12:16:08 PM
import {
	useNetwork,
	useContract,
	UseContractConfig,
 ...
 *
 */
export const consentualAttestationStationAddress = {
 ...
 *
 */
export const consentualAttestationStationConfig = {
	address: consentualAttestationStationAddress,
...
export function useConsentualAttestationStation(
	config: Omit<UseContractConfig, 'abi' | 'address'> & {
		chainId?: keyof typeof consentualAttestationStationAddress
	} = {} as any,
) {
	return useContract({
		abi: consentualAttestationStationABI,
		address: consentualAttestationStationAddress[31337],
		...config,
	})
}
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `functionName` set to `"getAttestation"`.
 *
 *
 */
export function useConsentualAttestationStationGetAttestation<
	TSelectData = ReadContractResult<
		typeof consentualAttestationStationABI,
		'getAttestation'
	>,
...
export function useConsentualAttestationStationWrite<
	TMode extends WriteContractMode,
	TFunctionName extends string,
	TChainId extends number = keyof typeof consentualAttestationStationAddress,
>(
	config: TMode extends 'prepared'
		? UseContractWriteConfig<
				TMode,
