// Generated by @wagmi/cli@0.1.10 on 3/24/2023 at 8:36:21 AM
import {
	useNetwork,
	useContract,
	UseContractConfig,
		...
		inputs: [
			{
				name: '_attestations',
				internalType:
					'struct ConsentualAttestationStation.AttestationData[]',
				type: 'tuple[]',
				components: [
					{ name: 'about', internalType: 'address', type: 'address' },
					{ name: 'key', internalType: 'bytes32', type: 'bytes32' },
...
export const counterABI = [
	...
	},
	{
		...
		type: 'function',
		inputs: [
			{ name: 'newNumber', internalType: 'uint256', type: 'uint256' },
		],
		name: 'setNumber',
		outputs: [],
	},
