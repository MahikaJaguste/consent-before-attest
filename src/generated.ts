// Generated by @wagmi/cli@0.1.10 on 3/23/2023 at 8:12:38 AM
import {
  useNetwork,
  useContract,
  UseContractConfig,
...
export const consentualAttestationStationABI = [
  { stateMutability: 'nonpayable', type: 'constructor', inputs: [] },
  {
    type: 'event',
    anonymous: false,
  ...
  },
  {
    ...
    inputs: [
      {
        name: '_attestations',
        internalType: 'struct ConsentualAttestationStation.AttestationData[]',
        type: 'tuple[]',
        components: [
          { name: 'about', internalType: 'address', type: 'address' },
          { name: 'key', internalType: 'bytes32', type: 'bytes32' },
...
/**
 * Wraps __{@link useContract}__ with `abi` set to __{@link consentualAttestationStationABI}__.
 */
export function useConsentualAttestationStation(
  config: Omit<UseContractConfig, 'abi'> = {} as any,
) {
  return useContract({ abi: consentualAttestationStationABI, ...config })
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link consentualAttestationStationABI}__.
 */
export function useConsentualAttestationStationRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<
    typeof consentualAttestationStationABI,
    TFunctionName
  >,
>(
  config: Omit<
  ...
  return useContractRead({
    abi: consentualAttestationStationABI,
    ...config,
  } as UseContractReadConfig<
    typeof consentualAttestationStationABI,
    TFunctionName,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `functionName` set to `"attestations"`.
 */
export function useConsentualAttestationStationAttestations<
  TSelectData = ReadContractResult<
    typeof consentualAttestationStationABI,
    'attestations'
  >,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `functionName` set to `"getEthSignedMessageHash"`.
 */
export function useConsentualAttestationStationGetEthSignedMessageHash<
  TSelectData = ReadContractResult<
    typeof consentualAttestationStationABI,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `functionName` set to `"getMessageHash"`.
 */
export function useConsentualAttestationStationGetMessageHash<
  TSelectData = ReadContractResult<
    typeof consentualAttestationStationABI,
    'getMessageHash'
  >,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `functionName` set to `"recoverSigner"`.
 */
export function useConsentualAttestationStationRecoverSigner<
  TSelectData = ReadContractResult<
    typeof consentualAttestationStationABI,
    'recoverSigner'
  >,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `functionName` set to `"splitSignature"`.
 */
export function useConsentualAttestationStationSplitSignature<
  TSelectData = ReadContractResult<
    typeof consentualAttestationStationABI,
    'splitSignature'
  >,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `functionName` set to `"verifyConsent"`.
 */
export function useConsentualAttestationStationVerifyConsent<
  TSelectData = ReadContractResult<
    typeof consentualAttestationStationABI,
    'verifyConsent'
  >,
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `functionName` set to `"version"`.
 */
export function useConsentualAttestationStationVersion<
  TSelectData = ReadContractResult<
    typeof consentualAttestationStationABI,
    'version'
  >,
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link consentualAttestationStationABI}__.
 */
export function useConsentualAttestationStationWrite<
  TMode extends WriteContractMode,
  TFunctionName extends string,
>(
  config: TMode extends 'prepared'
  ...
  return useContractWrite<
    ...
    typeof consentualAttestationStationABI,
    TFunctionName
  >({ abi: consentualAttestationStationABI, ...config } as any)
}

/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `functionName` set to `"attest"`.
 */
export function useConsentualAttestationStationAttest<
  TMode extends WriteContractMode,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link consentualAttestationStationABI}__.
 */
export function usePrepareConsentualAttestationStationWrite<
  TFunctionName extends string,
>(
  config: Omit<
    UsePrepareContractWriteConfig<
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `functionName` set to `"attest"`.
 */
export function usePrepareConsentualAttestationStationAttest(
  config: Omit<
    UsePrepareContractWriteConfig<
      typeof consentualAttestationStationABI,
      'attest'
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link consentualAttestationStationABI}__.
 */
export function useConsentualAttestationStationEvent<TEventName extends string>(
  config: Omit<
    UseContractEventConfig<typeof consentualAttestationStationABI, TEventName>,
    'abi'
  > = {} as any,
) {
  return useContractEvent({
...
/**
 * Wraps __{@link useContractEvent}__ with `abi` set to __{@link consentualAttestationStationABI}__ and `eventName` set to `"AttestationCreated"`.
 */
export function useConsentualAttestationStationAttestationCreatedEvent(
  config: Omit<
    UseContractEventConfig<
      typeof consentualAttestationStationABI,
      'AttestationCreated'
